...
/*
addrs是一个数组，元素个数为naddrs，类型为ngx_rtmp_in_addr_t
这个结构体作为ngx_listening_t结构体的servers字段
*/
...
typedef struct {
 ...
 /*
 在初始化时，ngx_rtmp_init_event_handlers中，将
 events[1[[0]=ngx_rtmp_protocol_message_handler
 evnets[2][0]=ngx_rtmp_protocol_message_handler
 events[3][0]=ngx_rtmp_protocol_message_handler
 events[5][0]=ngx_rtmp_protocol_message_handler
 evnets[6][0]=ngx_rtmp_protocol_message_handler

 events[15][0]=ngx_rtmp_amf_message_handler
 events[16][0]=ngx_rtmp_amf_message_handler
 events[17][0]=ngx_rtmp_amf_message_handler
 events[18][0]=ngx_rtmp_amf_message_handler
 evnets[19][0]=ngx_rtmp_amf_message_handler
 events[20][0]=ngx_rtmp_amf_message_handler

 events[4][0]=ngx_rtmp_user_message_handler

 events[22][0]=ngx_rtmp_aggregate_message_handler
 */
    ngx_array_t             events[NGX_RTMP_MAX_EVENT];

    ngx_hash_t              amf_hash;
/*
数组成员类型:ngx_hash_key_t
*/
    ngx_array_t             amf_arrays;
/*
数组成员类型:ngx_rtmp_amf_handler_t
*/
    ngx_array_t             amf;
